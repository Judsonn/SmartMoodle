...
import 'package:SmartMoodle/pages/activities/new/new_activity_content.dart';
...
class _NewActivityPageState extends State<NewActivityPage> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: <Widget>[
        DrawerWidget(1), //widget do drawer
        Transform.scale(
